...
public class JsonTestUtils {
    ...
    public static void assertJsonHashCodeEquals(JsonNode expected, JsonNode actual, String message) {
        if(expected == actual) {
            return;
        }else if(actual == null) {
        ...
        if(actualHashCode != expectedHashCode) {
            throw new AssertionFailedError("Hashcode did not match" +  message, expected.toString(), actual.toString());
        }
