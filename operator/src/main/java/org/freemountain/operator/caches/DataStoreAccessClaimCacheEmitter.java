...
public class DataStoreAccessClaimCacheEmitter extends CachedEmitter<DataStoreAccessClaimResource>{
    ...
    Publisher<DataStoreAccessClaimLifecycleEvent> connect() {
        SharedIndexInformer<DataStoreAccessClaimResource> informer = getInformerFactory().sharedIndexInformerForCustomResource(ctx.getConfig(), DataStoreAccessClaimResource.class, DataStoreAccessClaimResourceList.class, 60 *1000);
